...
namespace GitLink
{
    ...
    public static partial class StringExtensions
    {
        public static string GetGitHubCompanyName(this string url)
        {
            ...
            url = url.Replace(GitLinkEnvironment.GitHubUrl, string.Empty);
        ...
        public static string GetGitHubCompanyUrl(this string url)
        {
            ...
            return string.Format("{0}/{1}", GitLinkEnvironment.GitHubUrl, company);
        }
        ...
        public static string GetGitHubRawUrl(this string url)
        {
            ...
            return string.Format("{0}/{1}/{2}", GitLinkEnvironment.GitHubRawUrl, company, project);
        }
    }
}